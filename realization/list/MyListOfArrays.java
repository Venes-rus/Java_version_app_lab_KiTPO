...
public class MyListOfArrays {
    ...
    /**
     * Слияние подмассивов
     * @paramarr результирующий массив
     * @paramleftArr первый подмассив
     * @paramrightArr второй подмассив
     * @paramcomporator объект для сравнения значений пользовательских типов данных
     */
    ...
    public MyListOfArrays sort(Comporator comporator) {
